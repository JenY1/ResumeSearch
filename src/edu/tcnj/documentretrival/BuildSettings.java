...
public class BuildSettings 
	...
	public static boolean appendToInvertedIndex = true;
	/** if true, Build loads the document index and appends to it. */
	public static boolean appendToDocumentIndex = true;
	...
	*/
	...
	public static String searchDirectory = "Resumes"; 
...
*/
	...
	/* 7/10/2012
ublic static void loadSettings(String[] args)
		{
		if (args.length == 0)
			return;
